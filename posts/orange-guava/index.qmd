...
The aim of this model is to accept variables from the user such as pole to pole measurement, circumference, weight etc of a fruit and predict whether it is an orange or a guava using logistic regression.
